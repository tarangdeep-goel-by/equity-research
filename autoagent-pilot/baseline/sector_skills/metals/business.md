...
| **Ferro-alloys (manganese / chrome / ferro-silicon)** | Ore-grade × alloy realization − ore + power cost; ore-to-power arbitrage is the rent | Captive ore + captive / subsidised power; grade of ore (Mn %, Cr:Fe ratio) | EBITDA/tonne of alloy; power cost per tonne (power is 30-40% of alloy cost) |
| **Steel pipes / tubes (ERW / seamless)** | Pure conversion spread on merchant HRC / billet; API / oil-country tubular grades earn qualified premia | Inventory-lag discipline on HRC input; export-order book for seamless; API qualification for seamless oil-country goods | Conversion spread ($/t); inventory days; qualified-order share of mix |
