...
- **SEBI REIT regulations (2014, amended 2023; separate 2024 SM-REIT framework)** — distribution minimum **90% of Net Distributable Cash Flows (NDCF)**, not NOI (the standardised NDCF framework is effective FY25); sponsor 15% minimum for the first 3 years then a perpetual graded minimum (2023 amendment), 25% minimum public float, related-party-transaction restrictions. SM-REITs (2024) carry their own thresholds: ₹50-500 Cr asset size, sponsor 5% unleveraged / 15% leveraged.
- **Environment clearance — state-level** — under the EIA Notification 2006, building/construction (≥20,000 sqm) and townships/area-development (≥150,000 sqm built-up or >50 ha) are **Category B**, appraised at the STATE level by SEIAA/SEAC — *not* central MoEF-CC; townships ≥150,000 sqm fall in Category B1. (Central MoEF-CC appraisal is for Category A projects, which are not the typical real-estate development case.) Clearance delays of 6-18 months are routine; regime changes (e.g., EIA notification revisions) can invalidate in-process approvals.
...
- **Single-city concentration** — >40% of bookings (presales value) in one city is a stress vector. Historical examples: Gurugram oversupply 2018-20 hit DLF, ANANTRAJ, and NCR-heavy names; Mumbai oversupply 2022-23 hit LODHA (Macrotech Developers — same listed entity, NSE: LODHA, not two companies) and other MMR-heavy names; Bengaluru tech-job slowdown 2023 hit SOBHA, BRIGADE, PRESTIGE.
