...
- **Promoter pledge in diversified metals** — historically 40-60% pledge baseline in diversified mining groups; pledge drift +10 pp across 2-3 quarters is a late-cycle leverage distress signal. Compute LTV and margin-call headroom only where a pledged offshore-debt structure actually exists — VEDL (large-cap, Vedanta Resources parent) is the canonical pledged name; HINDALCO carries effectively nil pledge (Aditya Birla domestic promoter) and JSW Energy is a power company, not a metals producer — do not assume a 40-60% pledge baseline for either. Route via the ownership-agent handoff.
...
- **Steel safeguard and anti-dumping duties** — protect domestic producers from Chinese import flood; removal or reduction is the single biggest Indian steel regulatory *upside* risk. India imposed a 12% provisional safeguard duty on flat steel (HRC, CR, coated) in Apr 2025 and a definitive up-to-12% safeguard for 3 years in Dec 2025, with HRC exempt above a $675/t CIF floor price. Track the safeguard/ADD status and floor price — they set the import-parity ceiling on domestic realization (see Import Parity Pricing below).
- **Finished steel export duty (downside policy risk)** — distinct from the iron-ore export duty above. GoI has used sudden finished-steel export duties to cool domestic prices (a 15% export duty on most finished steel was imposed in May 2022, then withdrawn Nov 2022). A re-imposition of a 10-15% finished-steel export duty instantly crushes export-book margins — include it as a regulatory bear-case trigger for export-heavy producers.
...
- **EU CBAM (Carbon Border Adjustment Mechanism)** — definitive (financial-obligation) period began Jan 2026 for steel, aluminium, cement, fertilizer, hydrogen, electricity. EU-facing Indian metal exports pay a carbon-cost surcharge tied to embedded-emissions intensity. For a typical Indian BF-BOF steel exporter (~2.5-2.8 tCO₂ per tonne steel) at current EU ETS prices of €70-90/tCO₂, the *full-phase* surcharge would be ~€175-250/tonne — but CBAM phases in against the EU free-allocation drawdown, so only **~2.5% of that full cost is payable in 2026**, rising to 100% by 2034 (5% 2027, 10% 2028, ~48% by 2030). Do NOT model the full €150-250/t hit in 2026; the 2026 cash drag is a few €/tonne. Indian DRI is mostly coal-based (~2.0-3.0 tCO₂/t) and does NOT escape the drag — only gas-DRI / scrap-EAF at 0.8-1.2 tCO₂/t roughly halves the eventual full-phase surcharge.
...
- **CBAM at €90/tCO₂ on 30% EU-export share for BF-BOF producer** → at *full phase-in* (2034) export-book EBITDA/tonne −$150-250/t, equivalent to 8-15% total-EBITDA hit; in 2026 only ~2.5% of that applies (single-digit €/t), so the near-term drag is immaterial and the risk is the 2027-2034 ramp.
