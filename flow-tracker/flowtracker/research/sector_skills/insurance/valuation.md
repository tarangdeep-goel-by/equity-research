...
- **Par-dominated book → structurally lower VNB margin** — LICI's new business is heavily par-product concentrated, which produces VNB margin in the 13-17% range vs 25-30% for top-tier private insurers with diversified non-par + protection + ULIP mix. Do not benchmark LICI's VNB margin against the private-insurer median; the comparison is apples-to-oranges.
