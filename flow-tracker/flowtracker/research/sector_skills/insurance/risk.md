...
- **Board composition** — IRDAI's corporate-governance framework requires a minimum of three independent directors on every insurer's board (the earlier 50%-independent-board requirement for foreign-invested insurers was removed by the Insurance Laws (Amendment) Act, 2025). Any board reshuffle that drops independent-director count below the statutory minimum is a governance signal even without an explicit dissent.
...
- **GST on insurance premiums** — the 56th GST Council cut GST to **0% on all individual life and individual health policies (incl. family floaters) effective 22 Sept 2025**; group/employer policies remain at 18%. The risk is now second-order: insurers lose input-tax-credit on the exempted lines (a margin/cost drag) and the affordability tailwind on individual term/health is already in base premiums, not a pending catalyst.
- **Ind AS 117 / IFRS-17 transition (effective from FY27, April 2026)** — replaces premium-driven top-line with the Contractual Service Margin (CSM) as the unearned-profit store and introduces fair-value / discounting-led measurement. Legacy premium-growth and reported-P&L metrics become partially obsolete for FY27+; expect discounting-rate-led earnings volatility and a peer-ranking reshuffle as insurers re-present VNB, reserves, and solvency. For forward estimates track CSM as the new profitability KPI, not headline premium growth.
- **Insurance Laws (Amendment) Act, 2025 (100% FDI + composite licences)** — raises the FDI ceiling to 100% (automatic route) and introduces composite licences letting a single insurer write both life and general/health. Two distinct risks: (i) M&A / promoter-exit and control-change risk now that foreign parents can buy out to 100%; (ii) the structural moat of standalone health insurers (STARHEALTH, NIVABUPA) erodes as large life insurers enter health via composite licences and compete on price/distribution. Name the specific exposure when it crystallises.
- **Revised surrender-value norms (effective 1 Oct 2024)** — higher Special Surrender Value (SSV) on early exits, with the SSV discount rate capped at 10Y G-sec + 50 bps. Structurally compresses life-insurer VNB margins (~100 bps gross drag flagged by HDFC Life) and is forcing a shift from upfront to trail commission structures — a margin-and-distribution reset, not a one-off.
...
- **10Y G-sec rally of 100+ bps (yields falling −100 bps)** — compresses life-insurer par-fund return + non-par new-business pricing + general-insurer float income simultaneously. ROEV compresses 150-250 bps, combined ratio deterioration of 200-300 bps, and P/EV de-rates 20-40%. Conversely, **a 100 bps selloff (yields rising +100 bps)** inflicts an immediate MTM hit on the fixed-income portfolio (EV -5 to -8% on disclosure) but expands future non-par guaranteed-return VNB margins as the reinvestment rate rises — the two directions hit EV and VNB on opposite axes; state which direction the stress is running.
...
- **100 bps G-sec move (state direction)** — investment-yield impact 30-50 bps on float within 4-6 quarters (shorter for general insurers with shorter-duration reserves, longer for life with long-tail liabilities); par-fund new-business pricing reset of 10-25 bps on VNB margin. A yield rally (yields falling) compresses future reinvestment returns and par-fund VNB margin; a yield selloff (yields rising) produces an immediate EV MTM drag of 5-8% on disclosure but expands future non-par guaranteed-return VNB margin on the reinvestment leg. Name the direction before quoting the number.
