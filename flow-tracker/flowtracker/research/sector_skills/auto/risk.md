...
- **MoHI (Ministry of Heavy Industries)** — **FAME-II** subsidy (currently phasing down, scheme-end cliff risk), **EV PLI** (₹26,058 Cr corpus with capacity and DVA thresholds), **Auto PLI** (advanced-automotive-technology carve-out with ₹25,938 Cr).
