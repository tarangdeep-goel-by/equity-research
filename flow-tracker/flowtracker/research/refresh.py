    ...
    with FlowStore() as store:
        ...
        try:
            ...
            with ScreenerClient() as sc:
                ...
                try:
                    from flowtracker.research.concall_extractor import ensure_transcript_pdfs
                    downloaded = ensure_transcript_pdfs(symbol, max_quarters=6)
                    if downloaded:
        ...
        # Corporate actions (dividends, splits, bonuses) from yfinance
        try:
            ...
            with FilingClient() as fc:
                ...
                if actions:
                    ...
                    _skip("corporate_actions", "no data")
        except Exception as e:
            _skip("corporate_actions", str(e))
