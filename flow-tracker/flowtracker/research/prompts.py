...
1. `get_company_info` — Get the company name, industry, and sector. This anchors all your analysis.
   **BFSI Check:** If industry is a bank, NBFC, or financial services company, immediately call `get_bfsi_metrics` for NIM, ROA, Cost-to-Income, and equity multiplier trends. Use these as your PRIMARY efficiency metrics instead of standard OPM/EBITDA analysis. See the BFSI Mode section appended to this prompt.
